              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Buyer Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Purchase History</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="PurchaseHistory" type="text" placeholder="Enter PurchaseHistory" v-model="buyerDetails.purchaseHistory"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Wishlist</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Wishlist" type="text" placeholder="Enter Wishlist" v-model="buyerDetails.wishlist"></input>
																		</div>
						</td>
														</tr>
