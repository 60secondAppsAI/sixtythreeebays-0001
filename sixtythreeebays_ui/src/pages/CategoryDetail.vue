              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Category Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Category Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="CategoryName" type="text" placeholder="Enter CategoryName" v-model="categoryDetails.categoryName"></input>
																		</div>
						</td>
														</tr>
															<tr> 
