						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="PromotionDetails" type="text" placeholder="Enter PromotionDetails" v-model="promotionToAdd.promotionDetails"></base-input>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Promotion Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Promotion Details</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="PromotionDetails" type="text" placeholder="Enter PromotionDetails" v-model="promotionDetails.promotionDetails"></input>
																		</div>
						</td>
														</tr>
															<tr> 
