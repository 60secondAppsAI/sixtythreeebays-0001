    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'promotionDetails',
          visible: true,
          scopedSlots: { customRender: 'promotionDetails' },
          sorter: true
          //sorter: (a, b) => a.promotionDetails - b.promotionDetails,
          //sorter: (a, b) => a.promotionDetails.localeCompare(b.promotionDetails),
        },
        {
          title: 'Start Date',
		dataIndex: 'startDate',
